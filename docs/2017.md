...
2017 was the very first NDC TechTown. The event was hosted in Kongsberg, from Tuesday October 17 to Friday October 20. Approximately 300 attendees.
...
- (2 days) To (Embedded) Debian, and Beyond, ​Bill Gatliff
- (2 days) Mixed Reality Development with HoloLens, Lars Klint
- (2 days) Test-Driven Development for Embedded C/C++, James Grenning
- (2 days) Continuous Delivery of Embedded Software, Mike Long
- (2 days) Intermediate Python, Robert Smallshire
- (2 days) Crafting Embedded Software in C++, Dan Saks
- (2 days) Fastware: The Art of Optimizing C++ Code, Andrei Alexandrescu
- (2 days) Towards an Agile Design, Venkat Subramaniam
- (2 days) Practical Machine Learning with Functional Programming, Evelina Gabasova and Mathias Brandewinder
...
- Design by Introspection, Andrei Alexandrescu ([YouTube](https://youtu.be/k31wZafAMhk))
